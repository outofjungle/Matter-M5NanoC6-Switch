#!/bin/bash
# Flash and monitor ESP32-C6 from Docker using RFC2217 remote serial port
...
echo -e "${GREEN}Flashing and monitoring ESP32-C6 via RFC2217...${NC}"
...
# Run idf.py flash monitor with RFC2217
